...
public class Yobou_10_1_3 extends Activity {
    ...
    private static final String DAY10_2 = "DA10_2";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yobou_10_1_3);
        ...
        //初回予防接種の目安
        TextView meyasu10_3 = (TextView)findViewById(R.id.meyasu10_3);
        ...
        View saveButton10_3 = (Button) findViewById(R.id.save10_3);
        saveButton10_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                final EditText nameText1_1_1 = (EditText)findViewById(R.id.edityobou10_3);
                ...
                if(nameText1_1_1.getText().toString().equals("") == false)
                {
                    ...
                    Toast.makeText(Yobou_10_1_3.this, "日付を入力してください", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void onclick_ed_10_3(View view) {
        ...
        DatePickerDialog d_date = new DatePickerDialog(
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                Yobou_10_1_3.this.year_yobou_10_3 = year;
                month2_yobou_10_3 = monthOfYear;
                day_yobou_10_3 = dayOfMonth;


                EditText txtDate = (EditText) Yobou_10_1_3.this.findViewById(R.id.edityobou10_3);
                // Setした日付を取得する
    ...
    //プレファレンスに保存
    private void savePrefs10_3() {
        SharedPreferences prefs = getSharedPreferences(PREFS_FILE, Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt("YEAR10_3", year_yobou_10_3);
        editor.putInt("MONTH10_3", month2_yobou_10_3);
        editor.putInt("DAY10_3", day_yobou_10_3);
        editor.commit();
