...
public class Yobou_2_1_3 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yobou_2_1_3);
        ...
        //初回予防接種の目安
        TextView meyasu2_3 = (TextView)findViewById(R.id.meyasu2_3);
        ...
        View saveButton2_3 = (Button) findViewById(R.id.save2_1_3);
        saveButton2_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                final EditText nameText1_1_1 = (EditText)findViewById(R.id.edityobou2_3);
                ...
                if(nameText1_1_1.getText().toString().equals("") == false)
                {
                    ...
                    Toast.makeText(Yobou_2_1_3.this, "日付を入力してください", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void onclick_ed_2_3(View view) {
        ...
        DatePickerDialog d_date = new DatePickerDialog(
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                Yobou_2_1_3.this.year_yobou_2_3 = year;
                month2_yobou_2_3 = monthOfYear;
                day_yobou_2_3 = dayOfMonth;


                EditText txtDate = (EditText) Yobou_2_1_3.this.findViewById(R.id.edityobou2_3);
                // Setした日付を取得する
    ...
    //プレファレンスに保存
    private void savePrefs2_3() {
        SharedPreferences prefs = getSharedPreferences(PREFS_FILE, Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt("YEAR2_3", year_yobou_2_3);
        editor.putInt("MONTH2_3", month2_yobou_2_3);
        editor.putInt("DAY2_3", day_yobou_2_3);
        editor.commit();
