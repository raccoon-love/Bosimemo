...
public class Yobou_4_1_2 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yobou_4_1_2);
        ...
        //初回予防接種の目安
        TextView meyasu4_2 = (TextView)findViewById(R.id.meyasu4_2);
        ...
        View saveButton4_2 = (Button) findViewById(R.id.save4_2);
        saveButton4_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                final EditText nameText1_1_1 = (EditText)findViewById(R.id.edityobou4_2);
                ...
                if(nameText1_1_1.getText().toString().equals("") == false)
                {
                    ...
                    Toast.makeText(Yobou_4_1_2.this, "日付を入力してください", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void onclick_ed_4_2(View view) {
        ...
        DatePickerDialog d_date = new DatePickerDialog(
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                Yobou_4_1_2.this.year_yobou_4_2 = year;
                month2_yobou_4_2 = monthOfYear;
                day_yobou_4_2 = dayOfMonth;


                EditText txtDate = (EditText) Yobou_4_1_2.this.findViewById(R.id.edityobou4_2);
                // Setした日付を取得する
    ...
    //プレファレンスに保存
    private void savePrefs4_2() {
        SharedPreferences prefs = getSharedPreferences(PREFS_FILE, Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt("YEAR4_2", year_yobou_4_2);
        editor.putInt("MONTH4_2", month2_yobou_4_2);
        editor.putInt("DAY4_2", day_yobou_4_2);
        editor.commit();
