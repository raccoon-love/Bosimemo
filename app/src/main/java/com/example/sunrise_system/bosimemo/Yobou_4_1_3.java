...
public class Yobou_4_1_3 extends Activity {
    ...
    private static final String DAY4_2 = "DA4_2";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yobou_4_1_3);
        ...
        //初回予防接種の目安
        TextView meyasu4_3 = (TextView)findViewById(R.id.meyasu4_3);
        ...
        View saveButton4_3 = (Button) findViewById(R.id.save4_3);
        saveButton4_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                final EditText nameText1_1_1 = (EditText)findViewById(R.id.edityobou4_3);
                ...
                if(nameText1_1_1.getText().toString().equals("") == false)
                {
                    ...
                    Toast.makeText(Yobou_4_1_3.this, "日付を入力してください", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void onclick_ed_4_3(View view) {
        ...
        DatePickerDialog d_date = new DatePickerDialog(
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                Yobou_4_1_3.this.year_yobou_4_3 = year;
                month2_yobou_4_3 = monthOfYear;
                day_yobou_4_3 = dayOfMonth;


                EditText txtDate = (EditText) Yobou_4_1_3.this.findViewById(R.id.edityobou4_3);
                // Setした日付を取得する
    ...
    //プレファレンスに保存
    private void savePrefs4_3() {
        SharedPreferences prefs = getSharedPreferences(PREFS_FILE, Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt("YEAR4_3", year_yobou_4_3);
        editor.putInt("MONTH4_3", month2_yobou_4_3);
        editor.putInt("DAY4_3", day_yobou_4_3);
        editor.commit();
