...
public class Yobou_5_1_3 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yobou_5_1_3);
        ...
        //初回予防接種の目安
        TextView meyasu5_3 = (TextView)findViewById(R.id.meyasu5_3);
        ...
        View saveButton5_3 = (Button) findViewById(R.id.save5_3);
        saveButton5_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                final EditText nameText1_1_1 = (EditText)findViewById(R.id.edityobou5_3);
                ...
                if(nameText1_1_1.getText().toString().equals("") == false)
                {
                    ...
                    Toast.makeText(Yobou_5_1_3.this, "日付を入力してください", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void onclick_ed_5_3(View view) {
        ...
        DatePickerDialog d_date = new DatePickerDialog(
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                Yobou_5_1_3.this.year_yobou_5_3 = year;
                month2_yobou_5_3 = monthOfYear;
                day_yobou_5_3 = dayOfMonth;


                EditText txtDate = (EditText) Yobou_5_1_3.this.findViewById(R.id.edityobou5_3);
                // Setした日付を取得する
    ...
    //プレファレンスに保存
    private void savePrefs5_3() {
        SharedPreferences prefs = getSharedPreferences(PREFS_FILE, Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt("YEAR5_3", year_yobou_5_3);
        editor.putInt("MONTH5_3", month2_yobou_5_3);
        editor.putInt("DAY5_3", day_yobou_5_3);
        editor.commit();
