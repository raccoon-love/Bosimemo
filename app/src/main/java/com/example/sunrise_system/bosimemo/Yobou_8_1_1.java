...
public class Yobou_8_1_1 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yobou_8_1_1);
        ...
        //初回予防接種の目安
        TextView meyasu8_1 = (TextView)findViewById(R.id.meyasu8_1);
        ...
        View saveButton8_1 = (Button) findViewById(R.id.save8_1);
        saveButton8_1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                final EditText nameText8_1 = (EditText)findViewById(R.id.edityobou8_1);


                //未記入があるかチェック
                if(nameText8_1.getText().toString().equals("") == false)
                {
                    ...
                    Toast.makeText(Yobou_8_1_1.this, "日付を入力してください", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void onclick_ed_8_1(View view) {
        ...
        DatePickerDialog d_date = new DatePickerDialog(
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                Yobou_8_1_1.this.year_yobou_8_1 = year;
                month2_yobou_8_1 = monthOfYear;
                day_yobou_8_1 = dayOfMonth;


                EditText txtDate = (EditText) Yobou_8_1_1.this.findViewById(R.id.edityobou8_1);
                // Setした日付を取得する
    ...
    //プレファレンスに保存
    private void savePrefs8_1() {
        SharedPreferences prefs = getSharedPreferences(PREFS_FILE, Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt("YEAR8_1", year_yobou_8_1);
        editor.putInt("MONTH8_1", month2_yobou_8_1);
        editor.putInt("DAY8_1", day_yobou_8_1);
        editor.commit();
